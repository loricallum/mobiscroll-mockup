...
calendar = mobiscroll.eventcalendar("#demo-work-order-scheduling", {
  ...
  data: [
    {
      start: "2023-01-02T06:00",
      end: "2023-01-02T14:00",
      title: "Farmhouse TPH",
    ...
    {
      start: "2023-01-04T12:00",
      end: "2023-01-04T20:00",
    ...
    {
      start: "2023-01-05T11:00",
      end: "2023-01-05T19:00",
    ...
    {
      start: "2023-01-06T08:00",
      end: "2023-01-06T16:00",
    ...
    {
      start: "2023-01-08T07:00",
      end: "2023-01-08T15:00",
    ...
    {
      start: "2023-01-10T11:00",
      end: "2023-01-10T19:00",
      title: "Farmhouse PSZ",
  ...
  renderScheduleEventContent: function (event) {
    return (
      "<div>" +
      event.title +
      '<span class="md-work-order-price-tag">$' +
      getCostString(event.original.cost) +
      "</span></div>"
    );
  }
});
...
function appendCheckboxes() {
  var checkboxes =
    '<div class="mbsc-grid mbsc-no-padding"><div class="mbsc-row">';
  ...
  for (var i = 0; i < myResources.length; ++i) {
    for (var j = 0; j < myResources[i].children.length; ++j) {
      ...
      checkboxes +=
        '<div class="mbsc-col-sm-4"><div class="mbsc-form-group-title">' +
        resource.name +
        "</div>";
